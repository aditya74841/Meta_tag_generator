"use client";
  ...
  export default function VideoOpenGraph() {
    ...
    const generateMetaTags = () => {
      ...
      if (tags) {
        ...
        tagsArray.forEach(tag => {
          metaTags.push(`<meta property="video:tag" content="${tag}" />`);
        });
      }
    ...
    return (
      <OpenGraphLayout
        title="Video Open Graph"
        description="Optimize your video content for social sharing and search engines with rich metadata."
        icon={Video}
        type="video"
      ...
      >
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="E.g. Next.js 14 Crash Course"
              value={title}
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="tutorial, javascript (comma separated)"
              value={tags}
