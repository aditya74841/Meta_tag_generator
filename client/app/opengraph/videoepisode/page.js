...
import {
  ...
  Person as ActorIcon,           // ✅ Fixed
  Camera as DirectorIcon,        // ✅ Fixed
  Edit as WriterIcon,
  PlayCircleOutline as PlayIcon,
  VideoLibrary as EpisodeBadgeIcon, // ✅ Fixed
...
const VideoEpisode = () => {
  ...
  const generateMetaTags = () => {
    ...
    metaTags.push('<meta property="og:type" content="video.episode" />');
    ...
    <Box sx={{ p: 3, background: "linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%)", minHeight: "100vh" }}>
      ...
      >
        <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
          <EpisodeIcon sx={{ fontSize: 32 }} />
          <Box>
            <Typography variant="h4" fontWeight="bold">
              Video Episode Open Graph Generator
            </Typography>
            <Typography variant="body1" sx={{ opacity: 0.9, mt: 1 }}>
              Create Open Graph meta tags for TV show episodes to optimize social media sharing and episode SEO.
            </Typography>
          </Box>
        </Box>
      </Paper>
      ...
      <Grid container spacing={3}>
              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={12}>
                  <Typography variant="h6" gutterBottom color="primary" fontWeight="bold">
                    <EpisodeBadgeIcon sx={{ mr: 1, verticalAlign: "middle" }} />
                    Episode Details
                  </Typography>
                </Grid>
                ...
                <Grid item xs={12}>
                  <TextField
                    fullWidth
                    label="Episode Title *"
                    placeholder="The One Where Ross Got High"
                    value={title}
                ...
                <Grid item xs={12}>
                  <TextField
                    fullWidth
                    label="Episode URL *"
                    placeholder="https://tv.example.com/friends/season-6/episode-9"
                    value={url}
                ...
                <Grid item xs={12}>
                  <TextField
                    fullWidth
                    label="Episode Thumbnail URL"
                    placeholder="https://example.com/episode-thumbnail.jpg"
                    value={imageUrl}
                    onChange={(e) => setImageUrl(e.target.value)}
                    error={!!errors.imageUrl}
                    helperText={errors.imageUrl || "Recommended size: 1200x675 pixels (16:9 aspect ratio for episodes)"}
                    InputProps={{
                ...
                <Grid item xs={12}>
                  <TextField
                    ...
                    placeholder="Ross lies about smoking pot in college, but the truth comes out during Thanksgiving dinner with unexpected consequences..."
                    multiline
                    rows={3}
                    value={description}
                ...
                <Grid item xs={12} sm={6}>
                  <TextField
                    ...
                    helperText={errors.duration || `${duration ? formatDuration(duration) : "0:00"} (typical TV episode: 20-60 mins)`}
                    InputProps={{
                ...
                <Grid item xs={12} sm={6}>
                  <TextField
                    ...
                    helperText="Episode original air date"
                ...
                <Grid item xs={12}>
                  <TextField
                    fullWidth
                    label="Tags"
                    placeholder="comedy, sitcom, friendship, thanksgiving, family"
                    multiline
                    rows={2}
                    value={tags}
                    onChange={(e) => setTags(e.target.value)}
                    helperText="Comma-separated list of tags associated with this episode"
                    InputProps={{
                ...
                <Grid item xs={12}>
                  ...
                  <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                    Add the main actors who appeared in this episode
                  </Typography>
                ...
                <Grid item xs={12}>
                  ...
                  <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                    Add the directors who directed this episode
                  </Typography>
                ...
                <Grid item xs={12}>
                  ...
                  <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                    Add the writers who wrote this episode
                  </Typography>
        ...
        <Grid item xs={12} lg={4}>
          <Stack spacing={2}>
            ...
            <Paper elevation={3} sx={{ borderRadius: 2, overflow: "hidden" }}>
              ...
              <Card sx={{ borderRadius: 0 }}>
                {imageUrl ? (
                  ...
                  >
                    <EpisodeIcon sx={{ fontSize: 48, color: "text.secondary" }} />
                ...
                <CardContent>
                  ...
                  <Typography variant="body2" color="text.secondary" paragraph>
                    {description ? 
                      ...
                      "Episode description will appear here..."
                    }
                  </Typography>
                  ...
                  {dateReleased && (
                    <Box sx={{ display: "flex", alignItems: "center", gap: 1, mt: 1 }}>
                      ...
                      <Typography variant="body2">
                        Aired: {formatDateForDisplay(dateReleased)}
                      </Typography>
                    </Box>
                  )}
                ...
                <Stack spacing={1}>
                  <Alert severity={title.trim() ? "success" : "error"} variant="outlined">
                    <Typography variant="caption">
                      Episode Title: {title.trim() ? "✓ Added" : "✗ Required"}
                    </Typography>
                  </Alert>
                  ...
                  <Alert severity={imageUrl.trim() ? "success" : "info"} variant="outlined">
                    <Typography variant="caption">
                      Thumbnail: {imageUrl.trim() ? "✓ Added" : "ℹ Optional but recommended"}
                    </Typography>
                  </Alert>
                  ...
                  <Alert severity={dateReleased ? "success" : "info"} variant="outlined">
                    <Typography variant="caption">
                      Air Date: {dateReleased ? "✓ Set" : "ℹ Optional"}
                    </Typography>
                  </Alert>

                  <Alert severity={getTagsArray().length > 0 ? "success" : "info"} variant="outlined">
                    <Typography variant="caption">
                      Tags: {getTagsArray().length > 0 ? `✓ ${getTagsArray().length} tags` : "ℹ Optional"}
                    </Typography>
                  </Alert>
                </Stack>
              </Box>
            ...
            {/* Episode Meta Tags Info */}
            <Paper elevation={3} sx={{ borderRadius: 2, overflow: "hidden" }}>
              <Box sx={{ bgcolor: "info.main", color: "white", p: 2 }}>
                <Typography variant="h6" fontWeight="bold">
                  ABOUT VIDEO EPISODE OPEN GRAPH
                </Typography>
              </Box>
              <Box sx={{ p: 2 }}>
                <Stack spacing={2}>
                  <Box>
                    ...
                    <Typography variant="caption" display="block" gutterBottom>
                      • Enhanced episode sharing on social media
                    </Typography>
                    <Typography variant="caption" display="block" gutterBottom>
                      • Better TV show SEO and discovery
                    </Typography>
                    <Typography variant="caption" display="block" gutterBottom>
                      • Rich previews with episode thumbnails
                    </Typography>
                    <Typography variant="caption" display="block">
                      • Professional TV episode presentation
                    </Typography>
                  </Box>
                  ...
                  <Box>
                    ...
                    <Typography variant="caption" display="block">
                      • og:type - video.episode classification
                    </Typography>
                  </Box>
                </Stack>
              </Box>
...
//   const generateMetaTags = () => {
//     let metaTags = `<meta property="og:type" content="video.episode">\n`;
