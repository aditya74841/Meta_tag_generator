      ...
      <div className="relative z-10">
        ...
        <section className="container mx-auto pt-20 pb-16 px-4">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            <Badge variant="outline" className="px-4 py-1.5 border-blue-500/30 text-blue-400 bg-blue-500/5 backdrop-blur-sm animate-in fade-in slide-in-from-bottom-3 duration-500">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 pt-4 animate-in fade-in slide-in-from-bottom-6 duration-1000">
              <Button size="lg" className="h-12 px-8 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-full shadow-lg shadow-blue-600/20">
                Get Started
              </Button>
              <Button size="lg" variant="outline" className="h-12 px-8 border-slate-700 hover:bg-slate-800 rounded-full text-slate-300">
                View Documentation
              </Button>
            </div>
          </div>
        ...
        <section className="container mx-auto px-4 mb-24">
          <div className="flex items-center justify-between mb-10">
            <div className="space-y-1">
              ...
              <p className="text-slate-400">Standardized meta tags for Facebook, LinkedIn, and more.</p>
            </div>
          </div>
              ...
              <Link href={gen.route} key={gen.id} className="group">
                <Card className="glass glass-hover h-full transition-all duration-300 border-white/5 hover:border-blue-500/30 overflow-hidden relative">
                  ...
                  <CardHeader className="pb-4">
                    ...
                    <CardTitle className="text-xl text-slate-100 group-hover:text-white transition-colors">{gen.title}</CardTitle>
        ...
        <section className="container mx-auto px-4 mb-24">
           <div className="flex items-center justify-between mb-10">
            <div className="space-y-1">
              ...
              <p className="text-slate-400">Optimized snippets for the X (formerly Twitter) platform.</p>
            </div>
          </div>
        ...
        <section className="container mx-auto px-4 mb-24">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 p-12 rounded-[2.5rem] bg-slate-900/50 border border-white/5 backdrop-blur-md">
            <div className="text-center space-y-2">
              <div className="text-4xl font-bold text-white tracking-tighter">17+</div>
              <div className="text-sm uppercase tracking-widest text-slate-500 font-bold">Generators</div>
            </div>
            <div className="text-center space-y-2">
              <div className="text-4xl font-bold text-white tracking-tighter">99.9%</div>
              <div className="text-sm uppercase tracking-widest text-slate-500 font-bold">Accuracy</div>
            </div>
            <div className="text-center space-y-2">
              <div className="text-4xl font-bold text-white tracking-tighter">30s</div>
              <div className="text-sm uppercase tracking-widest text-slate-500 font-bold">Avg. Time</div>
            </div>
            <div className="text-center space-y-2">
              <div className="text-4xl font-bold text-white tracking-tighter">Free</div>
              <div className="text-sm uppercase tracking-widest text-slate-500 font-bold">Forever</div>
            </div>
          </div>
        </section>
        ...
        <section className="container mx-auto px-4 pb-24">
           <div className="relative p-12 rounded-[3rem] overflow-hidden text-center bg-blue-600">
              ...
              <div className="relative z-10 space-y-6">
                <h2 className="text-4xl md:text-5xl font-black text-white">Ready to Optimize?</h2>
                <p className="text-blue-100 text-lg max-w-xl mx-auto">
                  Join thousands of developers and marketers who use MetaForge to perfect their social media presence.
                </p>
                <div className="pt-6">
                  <Button size="lg" variant="secondary" className="h-14 px-10 rounded-full font-bold text-lg bg-white text-blue-600 hover:bg-slate-100">
