...
//     let metaTags = `<meta property="og:type" content="video.tv_show">\n`;
...
const VideoTvShow = () => {
  ...
  const generateMetaTags = () => {
    ...
    metaTags.push('<meta property="og:type" content="video.tv_show" />');
    ...
    <Box sx={{ p: 3, background: "linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%)", minHeight: "100vh" }}>
      ...
      >
        <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
          <TvShowIcon sx={{ fontSize: 32 }} />
          <Box>
            <Typography variant="h4" fontWeight="bold">
              Video TV Show Open Graph Generator
            </Typography>
            <Typography variant="body1" sx={{ opacity: 0.9, mt: 1 }}>
              Create Open Graph meta tags for TV shows to optimize social media sharing and television SEO.
            </Typography>
          </Box>
        </Box>
      </Paper>
      ...
      <Grid container spacing={3}>
              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={12}>
                  <Typography variant="h6" gutterBottom color="primary" fontWeight="bold">
                    <ShowBadgeIcon sx={{ mr: 1, verticalAlign: "middle" }} />
                    TV Show Details
                  </Typography>
                </Grid>
                ...
                <Grid item xs={12}>
                  <TextField
                    fullWidth
                    label="TV Show URL *"
                    placeholder="https://tv.example.com/breaking-bad"
                    value={url}
                    onChange={(e) => setUrl(e.target.value)}
                    error={!!errors.url}
                ...
                <Grid item xs={12}>
                  <TextField
                    ...
                    helperText={errors.imageUrl || "Recommended size: 1200x1800 pixels (2:3 aspect ratio for TV show posters)"}
                    InputProps={{
                ...
                <Grid item xs={12}>
                  <TextField
                    fullWidth
                    label="Show Synopsis"
                    placeholder="A high school chemistry teacher turned methamphetamine manufacturer partners with a former student to secure his family's financial future..."
                    multiline
                    rows={3}
                    value={description}
                    onChange={(e) => setDescription(e.target.value)}
                ...
                <Grid item xs={12} sm={6}>
                  <TextField
                    ...
                    helperText={errors.duration || `${duration ? formatDuration(duration) : "0:00"} (typical TV show: 20-60 mins)`}
                    InputProps={{
                ...
                <Grid item xs={12} sm={6}>
                  <TextField
                    ...
                    value={dateReleased}
                    onChange={(e) => setDateReleased(e.target.value)}
                    helperText="TV show premiere date"
                ...
                <Grid item xs={12}>
                  <TextField
                    fullWidth
                    label="Genre & Tags"
                    placeholder="drama, crime, thriller, dark comedy, AMC"
                    multiline
                    rows={2}
                    value={tags}
                    onChange={(e) => setTags(e.target.value)}
                    helperText="Comma-separated list of genres and tags associated with this TV show"
                    InputProps={{
                ...
                <Grid item xs={12}>
                  ...
                  <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                    Add the main actors who star in this TV show
                  </Typography>
                ...
                <Grid item xs={12}>
                  ...
                  <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                    Add the directors who directed this TV show
                  </Typography>
                ...
                <Grid item xs={12}>
                  ...
                  <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                    Add the writers who wrote this TV show
                  </Typography>
        ...
        <Grid item xs={12} lg={4}>
          <Stack spacing={2}>
            ...
            <Paper elevation={3} sx={{ borderRadius: 2, overflow: "hidden" }}>
              ...
              <Card sx={{ borderRadius: 0 }}>
                {imageUrl ? (
                  ...
                  >
                    <TvShowIcon sx={{ fontSize: 64, color: "text.secondary" }} />
                ...
                <CardContent>
                  ...
                  <Typography variant="body2" color="text.secondary" paragraph>
                    {description ? 
                      ...
                      "TV show synopsis will appear here..."
                    }
                  </Typography>
                  ...
                  {duration && (
                    <Box sx={{ display: "flex", alignItems: "center", gap: 1, mt: 2 }}>
                      ...
                      <Typography variant="body2">
                        Episode Runtime: {formatDuration(duration)}
                      </Typography>
                    </Box>
                  )}
                  ...
                  {dateReleased && (
                    <Box sx={{ display: "flex", alignItems: "center", gap: 1, mt: 1 }}>
                      ...
                      <Typography variant="body2">
                        Premiere: {formatDateForDisplay(dateReleased)}
                      </Typography>
                    </Box>
                  )}
                ...
                <Stack spacing={1}>
                  <Alert severity={title.trim() ? "success" : "error"} variant="outlined">
                    <Typography variant="caption">
                      TV Show Title: {title.trim() ? "✓ Added" : "✗ Required"}
                    </Typography>
                  </Alert>
                  ...
                  <Alert severity={imageUrl.trim() ? "success" : "info"} variant="outlined">
                    <Typography variant="caption">
                      Show Poster: {imageUrl.trim() ? "✓ Added" : "ℹ Optional but recommended"}
                    </Typography>
                  </Alert>
                  ...
                  <Alert severity={duration ? "success" : "info"} variant="outlined">
                    <Typography variant="caption">
                      Episode Runtime: {duration ? `✓ ${formatDuration(duration)}` : "ℹ Optional"}
                    </Typography>
                  </Alert>
                  ...
                  <Alert severity={dateReleased ? "success" : "info"} variant="outlined">
                    <Typography variant="caption">
                      Premiere Date: {dateReleased ? "✓ Set" : "ℹ Optional"}
                    </Typography>
                  </Alert>
            ...
            {/* TV Show Meta Tags Info */}
            <Paper elevation={3} sx={{ borderRadius: 2, overflow: "hidden" }}>
              <Box sx={{ bgcolor: "info.main", color: "white", p: 2 }}>
                <Typography variant="h6" fontWeight="bold">
                  ABOUT TV SHOW OPEN GRAPH
                </Typography>
              </Box>
              <Box sx={{ p: 2 }}>
                <Stack spacing={2}>
                  <Box>
                    ...
                    <Typography variant="caption" display="block" gutterBottom>
                      • Enhanced TV show sharing on social media
                    </Typography>
                    <Typography variant="caption" display="block" gutterBottom>
                      • Better streaming and television SEO
                    </Typography>
                    <Typography variant="caption" display="block" gutterBottom>
                      • Rich previews with show posters
                    </Typography>
                    <Typography variant="caption" display="block">
                      • Professional TV show presentation
                    </Typography>
                  </Box>
                  ...
                  <Box>
                    ...
                    <Typography variant="caption" display="block" gutterBottom>
                      • video:duration - Episode runtime
                    </Typography>
                    <Typography variant="caption" display="block">
                      • og:type - video.tv_show classification
                    </Typography>
                  </Box>
                </Stack>
              </Box>
