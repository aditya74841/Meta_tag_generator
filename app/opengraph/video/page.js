...
import {
  ...
  DirectionsRun as ActorIcon,
  CameraAlt as DirectorIcon,
  Edit as WriterIcon,
...
const Video = () => {
  ...
  const generateMetaTags = () => {
    ...
    metaTags.push('<meta property="og:type" content="video" />');
        ...
        <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
          ...
          <Box>
            <Typography variant="h4" fontWeight="bold">
              Video Open Graph Generator
            </Typography>
            <Typography variant="body1" sx={{ opacity: 0.9, mt: 1 }}>
              Create Open Graph meta tags for videos to optimize social media sharing and video SEO.
            </Typography>
          </Box>
        </Box>
      </Paper>
      ...
      <Grid container spacing={3}>
              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={12}>
                  <TextField
                    fullWidth
                    label="Video Title *"
                    placeholder="The Avengers: Endgame"
                    value={title}
                ...
                <Grid item xs={12}>
                  <TextField
                    fullWidth
                    label="Video URL *"
                    placeholder="https://video.example.com/avengers-endgame"
                    value={url}
                ...
                <Grid item xs={12}>
                  <TextField
                    ...
                    helperText={errors.imageUrl || "Recommended size: 1200x675 pixels (16:9 aspect ratio for videos)"}
                    InputProps={{
                ...
                <Grid item xs={12}>
                  <TextField
                    ...
                    placeholder="The epic conclusion to the Infinity Saga that changed the Marvel Cinematic Universe forever..."
                    multiline
                    rows={3}
                    value={description}
                ...
                <Grid item xs={12} sm={6}>
                  <TextField
                    ...
                    helperText={errors.duration || `${duration ? formatDuration(duration) : "0:00"} (1-86400 seconds)`}
                    InputProps={{
                ...
                <Grid item xs={12}>
                  <TextField
                    fullWidth
                    label="Tags"
                    placeholder="action, superhero, marvel, adventure, sci-fi"
                    multiline
                    rows={2}
                    value={tags}
                    onChange={(e) => setTags(e.target.value)}
                    helperText="Comma-separated list of tags associated with this video"
                    InputProps={{
                ...
                <Grid item xs={12}>
                  <Typography variant="h6" color="primary" fontWeight="bold" gutterBottom>
                    ...
                    Actors ({getValidActorsCount()} added)
                  </Typography>
                  <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                    Add the main actors who starred in this video
                  </Typography>
                ...
                <Grid item xs={12}>
                  ...
                  <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                    Add the directors who directed this video
                  </Typography>
                ...
                <Grid item xs={12}>
                  ...
                  <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                    Add the writers who wrote the screenplay for this video
                  </Typography>
        ...
        <Grid item xs={12} lg={4}>
          <Stack spacing={2}>
                ...
                <Stack spacing={1}>
                  <Alert severity={title.trim() ? "success" : "error"} variant="outlined">
                    <Typography variant="caption">
                      Video Title: {title.trim() ? "✓ Added" : "✗ Required"}
                    </Typography>
                  </Alert>
                  ...
                  <Alert severity={getValidActorsCount() > 0 ? "success" : "info"} variant="outlined">
                    <Typography variant="caption">
                      Actors: {getValidActorsCount() > 0 ? `✓ ${getValidActorsCount()} added` : "ℹ Optional"}
                    </Typography>
                  </Alert>
            ...
            {/* Video Meta Tags Info */}
            <Paper elevation={3} sx={{ borderRadius: 2, overflow: "hidden" }}>
              <Box sx={{ bgcolor: "info.main", color: "white", p: 2 }}>
                <Typography variant="h6" fontWeight="bold">
                  ABOUT VIDEO OPEN GRAPH
                </Typography>
              </Box>
              <Box sx={{ p: 2 }}>
                <Stack spacing={2}>
                  <Box>
                    ...
                    <Typography variant="caption" display="block" gutterBottom>
                      • Enhanced video sharing on social media
                    </Typography>
                    <Typography variant="caption" display="block" gutterBottom>
                      • Better video SEO and discovery
                    </Typography>
                    <Typography variant="caption" display="block" gutterBottom>
                      • Rich previews with thumbnails and play buttons
                    </Typography>
...
//   const generateMetaTags = () => {
//     let metaTags = `<meta property="og:type" content="video">\n`;
